...
description: Learn to read the aggregated grid and use recommended times and participant filters to find a slot for everyone.
---

## Read the aggregated grid

As participants add their times, the event page's grid shows everyone's availability **stacked together**. The **darker a cell, the more people are available** at that slot. The darkest cells are your best candidate times for getting everyone together.
