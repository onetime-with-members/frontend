...
export const guideContentsList = (
...
): GuideContents[] => [
  {
    ...
    imageSrc: {
      ko: '/images/schedule-guide/schedule-modal-1-ko.png',
      en: '/images/schedule-guide/schedule-modal-1-en.png',
    },
    imageAlt: {
  ...
  },
  {
    ...
    imageSrc: {
      ko: '/images/schedule-guide/schedule-modal-2-ko.png',
      en: '/images/schedule-guide/schedule-modal-2-en.png',
    },
    imageAlt: {
